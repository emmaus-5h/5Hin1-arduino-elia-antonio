...
const int GROEP_A = 1; // alle stoplichten ROOD
const int GROEP_B = 2; // alle stoplichten ORANJE
const int GROEP_C = 3; // alle stoplicht GROEN
const int GROEP_D = 4; // alle stoplichten ROOD
...
void loop() {
  ...
  /* deze code heb je nu niet nodig
      if (knop7 == HIGH || knop8 == HIGH) {
        ...
        toestandStartTijd = millis();
        toestand = GROEP_C;
        Serial.println("Nieuwe toestand: ");
      }
  */
